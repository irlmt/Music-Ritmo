...
def get_tracks_by_genre(genre_name: str, session: Session = Depends(db.get_session)):
    ...
    for track in genre.tracks:
        track_info = SubsonicTrack(
            ...
            parent=str(track.parent_id) if hasattr(track, 'parent_id') else SubsonicTrack.model_fields['parent'].default,
            ...
            albumId=str(track.album_id) if hasattr(track, 'album_id') else SubsonicTrack.model_fields['albumId'].default,
            album=str(track.album) if hasattr(track, 'album') else SubsonicTrack.model_fields['album'].default,
            artistId=str(track.artist_id) if hasattr(track, 'artist_id') else SubsonicTrack.model_fields['artistId'].default,
            ...
            samplingRate=track.sampling_rate if hasattr(track, 'sampling_rate') else SubsonicTrack.model_fields['samplingRate'].default,
            channelCount=track.channel_count if hasattr(track, 'channel_count') else SubsonicTrack.model_fields['channelCount'].default,
            userRating=track.user_rating if hasattr(track, 'user_rating') else SubsonicTrack.model_fields['userRating'].default,
            averageRating=track.average_rating if hasattr(track, 'average_rating') else SubsonicTrack.model_fields['averageRating'].default,
            ...
            discNumber=track.disc_number if hasattr(track, 'disc_number') else SubsonicTrack.model_fields['discNumber'].default,
            suffix=track.suffix if hasattr(track, 'suffix') else SubsonicTrack.model_fields['suffix'].default,
            contentType=track.content_type if hasattr(track, 'content_type') else SubsonicTrack.model_fields['contentType'].default,

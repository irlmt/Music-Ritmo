...
class MusicRitmoUser(HttpUser):
    ...
    def search(self):
        ...
        self.client.get(
            f"/rest/search3?query={query}&songCount=100&albumCount=100&artistCount=100&songOffset=0&albumOffset=0&artistOffset=0&username={self.username}&u={self.username}&p={self.password}"
        )
    ...
    def get_song(self):
        ...
        self.client.get(
            f"/rest/getSong?id={song_id}&username={self.username}&u={self.username}&p={self.password}"
        )
    ...
    def get_album(self):
        ...
        self.client.get(
            f"/rest/getAlbum?id={album_id}&username={self.username}&u={self.username}&p={self.password}"
        )

    @task(1)
    def get_starred(self):
        self.client.get(
            f"/rest/getStarred2?username={self.username}&u={self.username}&p={self.password}"
        )
